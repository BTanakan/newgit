            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="#">Track Parcels</a>
                        </li>
                        <li class="nav-item">
                ...
                <form action="post" class="row" id="PostalForm">
                    <div class="row g-4">
                        ...
                        <div class="col-md-12" style="display: flex;">
                            <select name="methoddb" id="">
                                <option value="1" selected>Receiver Name</option>
                                <option value="2">Track Number</option>
                            </select>
